import { createClient } from '/SPYC-study-room-attendance-system-check-in.github.io/@supabase/supabase-js';
...
export const supabase = createClient('https://puisbpdboykphyeexnrh.supabase.co', 
